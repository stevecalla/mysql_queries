...
-- THE PURPOSE OF THIS QUERY IS TO UNDERSTAND THE TABLE LAYOUT/JOINS FROM rental_cars_available, rental_car, rental_cat and rental_car_booking2
SELECT 
	--  rental_cars_available TABLE
