...
DROP TABLE IF EXISTS user_data_cohort_base;
...
SHOW INDEXES FROM user_data_cohort_base;
...
ALTER TABLE user_data_cohort_base
    ADD COLUMN created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;

-- Select all records with a limit of 10
SELECT * FROM user_data_cohort_base LIMIT 10;
